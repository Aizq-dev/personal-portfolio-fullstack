...
export const seed: SeedData = {
  profile: [
    // ES
    {
      ...
      avatar: "https://res.cloudinary.com/ddumhsyl6/image/upload/v1756289125/fotoperfil.jpg",
      ...
      links: [
        ...
        { icon: "linkedin", url: "https://linkedin.com/in/adrian-izquierdo-delgado" },
  ...
  projects: [
    ...
    // ES
    {
      ...
      tech: ["HTML", "CSS"],
      githubUrl: "https://github.com/Aizq-dev/Proyecto.Frontend.1-WebResponsive",
    ...
    // EN
    {
      ...
      description: "Static landing page built with plain HTML and CSS. The goal was to practice semantic structure, responsive design, and custom styling without frameworks. This project helped me solidify frontend fundamentals and learn how to craft a clean interface from scratch.",
      img: "https://res.cloudinary.com/ddumhsyl6/image/upload/v1756288277/lading-page-img.png",
      gif: "https://res.cloudinary.com/ddumhsyl6/video/upload/v1756288634/landing-page-gif.mp4",
      tech: ["HTML", "CSS"],
      githubUrl: "https://github.com/Aizq-dev/Proyecto.Frontend.1-WebResponsive",
    ...
    // EN
    {
      ...
      description: "Product listing with dynamic filtering by name and price using vanilla JavaScript. I added business logic to the frontend, worked with arrays of objects, and manipulated the DOM to update the UI in real time. It also reinforced responsive design and UX focus.",
      img: "https://res.cloudinary.com/ddumhsyl6/image/upload/v1756288270/filterlist-img.png",
      gif: "https://res.cloudinary.com/ddumhsyl6/video/upload/v1757328441/filterlist-gif.mp4",
      tech: ["JavaScript", "HTML", "CSS"],
      githubUrl: "https://github.com/Aizq-dev/Proyecto.Frontend.2.web.Dinamica",
    ...
    // ES
    {
      ...
      githubUrl: "https://github.com/Aizq-dev/Proyecto.Frontend.Nasa.React.Basic",
    ...
    {
      locale: "es",
      title: "WeatherApp - Clima en tiempo real con geolocalización y predicción extendida",
    ...
    // ES
    {
      ...
      tech: ["React", "React DOM", "React Router DOM", "Reactstrap", "Sudoku (lib npm)", "Vite", "ESLint", "CSS"],
      githubUrl: "https://github.com/Aizq-dev/Proyecto.Frontend.6.GameHub/tree/main",
    ...
    // ES
    {
      ...
      tech: ["React", "JavaScript", "Vite", "Styled-components", "Vitest", "React Testing Library", "JSDOM", "ESLint"],
    ...
    // EN
    {
      ...
      description: "Landing page built with React, focused on unit testing using Vitest and React Testing Library. The goal was to validate components, events, and expected UI behavior with automated tests. I also used styled-components for modular styling and a clean architecture. Vite powered a fast modern dev environment.",
      img: "https://res.cloudinary.com/ddumhsyl6/image/upload/v1756288344/pistachio-img.png",
      gif: "https://res.cloudinary.com/ddumhsyl6/video/upload/v1756288665/PISTACCHIO-gif.mp4",
      tech: ["React", "JavaScript", "Vite", "Styled-components", "Vitest", "React Testing Library", "JSDOM", "ESLint"],
      githubUrl: "https://github.com/Aizq-dev/Proyecto.Frontend.UnitTestDemo",
    ...
    // EN
    {
      ...
      description: "REST API built with Node.js, Express, and MongoDB to manage vehicles. It provides full CRUD endpoints, filtering by model or brand via query params, and a seeding mechanism on server start to reset data automatically. This project covers backend fundamentals: route design, controllers, and Mongoose modeling.",
      img: "",
      gif: "",
      tech: ["Node.js", "Express", "MongoDB", "Mongoose", "JavaScript"],
      githubUrl: "https://github.com/Aizq-dev/Proyecto-1-Backend",
    ...
    // ES
    {
      ...
      img: "",
      gif: "",
      tech: ["TypeScript", "React", "Node.js", "Express", "MongoDB", "Mongoose", "Vite", "HTML5", "CSS3", "API REST", "JWT (login admin - en desarrollo)"],
    ...
    // EN
    {
      ...
      description: "Work-in-progress professional Full-Stack portfolio built with TypeScript. All project content is managed in MongoDB and served via a custom API. The frontend is hand-crafted and includes a working contact form. I’m integrating an admin login to manage projects directly from the UI. This project showcases end-to-end skills across frontend and backend using modern tooling and typed code.",
      img: "",
      gif: "",
      tech: ["TypeScript", "React", "Node.js", "Express", "MongoDB", "Mongoose", "Vite", "HTML5", "CSS3", "API REST", "JWT (admin login — in progress)"],
      githubUrl: "https://github.com/Aizq-dev/personal-portfolio-fullstack",
      demoUrl: "",
      stack: "fullstack",
      origin: "personal"
    ...
    // ES
    {
      ...
      tech: ["HTML", "CSS", "JavaScript", "Funnelish", "Responsive Design", "Embudo de ventas"],
      githubUrl: "",
